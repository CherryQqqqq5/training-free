...
- Recommended tool distribution: `{'cat': 8, 'cd': 18, 'cp': 6, 'echo': 5, 'find': 4, 'grep': 4, 'mv': 4, 'touch': 18}`
- Rejection reason counts: `{'candidate_ready': 63, 'no_rule_hit': 372, 'no_schema_local_recommended_tool': 552, 'not_no_tool_policy_failure': 8185, 'postcondition_already_satisfied': 82}`
