...
Trace card outputs must follow `outputs/artifacts/stage1_bfcl_acceptance/abhe_trace_card.schema.json` and pass `scripts/check_abhe_trace_cards.py`. The current packet only fixes the output boundary; it does not perform extraction.
