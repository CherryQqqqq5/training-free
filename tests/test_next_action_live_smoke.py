...
class NextActionLiveSmokeTests(unittest.TestCase):
    ...
    def test_dry_run_compiles_and_writes_trace_summaries_without_network(self) -> None:
        ...
        self.assertEqual(summary["case_count"], 20)
        self.assertEqual(saved_summary["policy_plan_activated_count"], 11)
        self.assertEqual(saved_summary["next_tool_emitted_count"], 11)
        self.assertEqual(saved_summary["recommended_tool_match_count"], 10)
        self.assertEqual(saved_summary["arg_binding_match_count"], 8)
        self.assertEqual(saved_summary["normalized_arg_binding_match_count"], 8)
        self.assertEqual(saved_summary["final_arg_binding_match_count"], 4)
        self.assertEqual(saved_summary["final_normalized_arg_binding_match_count"], 8)
        self.assertEqual(saved_summary["blocked_reason_distribution"].get("action_candidate_guard_rejected", 0), 3)
