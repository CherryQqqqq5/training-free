...
def build_adapter(
    *,
    ...
    runtime_projection = [
        {
            ...
            "runtime_guidance_fragment_id": "state_summary_injection_plus_post_tool_continuation_compact_fragment_v1",
            "post_tool_continuation_guard": True,
            "finalize_only_after_required_tool_actions_complete": True,
    ...
    adapter = {
        ...
        "entry_specific_activation_required": True,
        "fallback_global_activation_allowed": False,
        "runtime_context_source": "runner_env_activation_entry_or_categories",
