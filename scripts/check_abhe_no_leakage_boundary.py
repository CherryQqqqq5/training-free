...
DEFAULT_PATHS = [
    ...
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_slice_plan.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_fresh_dev_slice_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_source_exclusion_proof.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_dev_smoke_approval_packet.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_smoke_baseline_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_smoke_candidate_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_smoke_candidate_arm_compact_v1_snapshot.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_smoke_result.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_smoke_result_v1_snapshot.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_feedback.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_dev_feedback_v1_snapshot.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_trace_analysis.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_trace_analysis_v2.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_failure_analysis.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_failure_analysis_v1_snapshot.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_expanded_bfcl_refinement_comparison.json"),
    Path("docs/stage1_abhe_v0_expanded_bfcl_analysis.md"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_fresh_slice_plan.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_fresh_slice_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_source_exclusion_proof.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_candidate_specs.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_result.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_baseline_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_frozen_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_missing_param_gate_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_long_context_retrieval_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_dev_smoke_both_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_runtime_candidate_adapter_frozen_v2.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_runtime_candidate_adapter_missing_param_gate.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_next_runtime_candidate_adapter_long_context_retrieval.json"),
    ...
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_stress_plan.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_stress_slice_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_source_exclusion_proof.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_missing_param_slot_recovery_candidate_spec.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_runtime_candidate_adapter_frozen_v2.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_runtime_candidate_adapter_slot_recovery_v1.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_dev_smoke_baseline_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_dev_smoke_frozen_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_dev_smoke_slot_recovery_v1_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_dev_smoke_result.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_paired_case_matrix.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_failure_analysis.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_missing_param_trace_taxonomy_audit_v0.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_miss_param_residual_archive_transition_dry_run.json"),
    Path("docs/stage1_abhe_v0_miss_param_residual_stress.md"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_micro_harness.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_missing_param_counterfactual_slot_audit_v0.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_diagnostic.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_stress_plan.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_stress_slice_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_source_exclusion_proof.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_candidate_spec.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_candidate_adapter_conditional_frozen_v2.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_candidate_adapter_runtime_slot_controller_v2.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_dev_smoke_baseline_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_dev_smoke_conditional_frozen_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_dev_smoke_runtime_slot_controller_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_dev_smoke_result.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_paired_case_matrix.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_residual_failure_analysis.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_archive_transition_dry_run.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_sanitized_trace_audit.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_causality_audit.json"),
    ...
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_alignment_sidecar.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_run_id_mapping_audit.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_failure.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_retry_stabilization_plan.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_reduced_batch_retry_request.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_reduced_batch_slice_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_reduced_batch_retry_dry_run_manifest.json"),
    ...
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_approval_packet.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_command_manifest.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_baseline_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_conditional_frozen_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_runtime_slot_controller_v2_arm_compact.json"),
    Path("outputs/artifacts/stage1_bfcl_acceptance/abhe_v0_runtime_slot_controller_distinct_rerun_result.json"),
    ...
    Path("docs/stage1_abhe_v0_runtime_slot_controller_diagnostic.md"),
