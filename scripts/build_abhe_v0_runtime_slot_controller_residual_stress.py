...
PLAN = ROOT / "abhe_v0_runtime_slot_controller_residual_stress_plan.json"
MANIFEST = ROOT / "abhe_v0_runtime_slot_controller_residual_stress_slice_manifest.json"
PROOF = ROOT / "abhe_v0_runtime_slot_controller_source_exclusion_proof.json"
...
PREVIOUS_MANIFESTS = [
    ...
    ROOT / "abhe_v0_miss_param_residual_stress_slice_manifest.json",
]
STRESS_COUNTS = {
...
ENTRY_BY_CATEGORY = {
    "multi_turn_miss_param": "runtime_slot_controller_v2",
...
def _select(dataset_path: Path, prior_hashes: set[str]) -> Tuple[List[Dict[str, str]], Dict[str, Any]]:
    ...
    for category, target_count in STRESS_COUNTS.items():
        ...
        for row_index, raw in rows:
            ...
            compact["slice_id"] = "runtime_slot_controller_residual_stress_v0"
...
def _spec(selected_hash: str) -> Dict[str, Any]:
    return {
        ...
        "supersedes": "missing_param_slot_recovery_controller_v1",
        "candidate_type": "runtime_slot_controller_v2",
...
def build(dataset_path: Path = DEFAULT_DATASET) -> Dict[str, Any]:
    ...
    manifest = {
        ...
        "slice_id": "runtime_slot_controller_residual_stress_v0",
    ...
    plan = {
        ...
        "purpose": "targeted_runtime_slot_controller_residual_mechanism_validation_not_full_bfcl",
        "bounded_dev_smoke_only": True,
        ...
        "arms": ["baseline", "frozen_v2", "runtime_slot_controller_v2"],
        "frozen_mechanisms": ["post_tool_continuation_guard_v0", "no_tool_boundary_v0"],
        "new_mechanism": "runtime_slot_controller_v2",
        "demoted_mechanisms": ["missing_param_slot_recovery_controller_v1"],
        ...
        "next_required_action": "run_runtime_slot_controller_residual_dev_smoke_and_sanitized_taxonomy",
        "blockers": blockers,
    }
