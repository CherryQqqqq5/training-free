...
def build_report() -> Dict[str, Any]:
    ...
    return {
        ...
        "abhe_v0_runtime_slot_dataset_extraction_audit_ready": review_bundle.get("abhe_v0_runtime_slot_dataset_extraction_audit_ready") is True,
        "abhe_v0_runtime_slot_reduced_batch_alignment_ledger_ready": review_bundle.get("abhe_v0_runtime_slot_reduced_batch_alignment_ledger_ready") is True,
        ...
        "component_summaries": {
            ...
            "abhe_v0_runtime_slot_dataset_extraction_audit": (review_bundle.get("component_summaries") or {}).get("abhe_v0_runtime_slot_dataset_extraction_audit"),
            "no_leakage": leakage,
        },
